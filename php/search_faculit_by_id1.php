 ...
 ?>
   <tbody>
 	<tr>
 		...
 		<td>
 		<a href="add_record_for_search_faculit_by_id1.php?id=<?php echo $id; ?>" class="btn btn-success">Add Record</a>
 		</td>
 		<td><a href="payment8.php?id=<?php echo $id; ?>" class="btn btn-success">Payment</a></td>
 	<?php } ?> 
 	</tr>
 	</tbody>
 </table>