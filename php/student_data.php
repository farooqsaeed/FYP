...
<body>
<div id="top" class="container-fluid bg-warning">
    <div class="row">
        <div class="col-lg-4">
...
include'connection.php';
		  ...
		  $sql = "SELECT ID,stu_name,room_no,pic_source FROM student_login";
                $result = mysqli_query($conn, $sql);
 ...
 ?>
    <tbody>
 	<tr>
 		...
 		<td><a href="delete_data.php?del=<?php echo $id; ?>">VIEW PROFILE</a></td>
 	<?php } ?> 
 	</tr>
 	</tbody>
    <a href="result.php" class="btn btn-success">Print ID Cards</a>
 </table>
 </div>
</div>
</body>
